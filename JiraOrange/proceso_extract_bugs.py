...
from etl.transform import transformar_bugs, transform
import pandas as pd
...
def main():
    ...
    for index, row in extracted_data.iterrows():
        dict_metrics['Incidencias'], dict_metrics['Bugs'], dict_metrics['Status'] = transformar_bugs(row)
    ...
    load_to_csv("salida.csv",df_filtrado)
